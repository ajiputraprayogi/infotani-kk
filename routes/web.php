...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/laporan-harian-tanaman', [LaporanController::class, 'showChartHarianTanaman']);
    Route::get('/laporan-harian-panen', [LaporanController::class, 'showChartHarianPanen']);
});
